...
class Customer {
  ...
  Customer({this.id, this.name, this.age, this.before_img, this.after_img, this.notes, this.created_at, this.updated_at, this.prescriptions, this.diagnosis}){
    if(this.created_at != null)
      this._since = getSince(this.created_at) ;
      }
    ...
    factory Customer.fromJson(Map<String, dynamic> json){
      ...
      return Customer(id: json['id'], name : json['name'], age: json['age'], before_img: json['before_img'],after_img: json['after_img'],notes: json['notes'], created_at: json['created_at'], updated_at: json['updated_at'], prescriptions: prescriptions, diagnosis: json['diagnosis']);
    }
