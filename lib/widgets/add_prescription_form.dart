      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: TextFormField(
              onSaved: (v) {
                _prescription.name = v;
              },
              validator: (v) {
                if (v.isEmpty) return "Prescription Name Can't be empty";
                if (v.length < 21) return "Prescription Name must be 21 Chars";
                return null;
              },
              maxLength: 21,
          ...
          Container(
            ...
            child: TextFormField(
              onSaved: (v) {
                _prescription.price = int.parse(v);
              },
              validator: (v) {
                if (v.isEmpty) return "Prescription Price Can't be empty";
                try {
                  double.parse(v);
          ...
          Container(
            ...
            child: TextFormField(
              onSaved: (v) {
                _prescription.creation_date = Utils.toServerDate(v);
              },
              validator: (v) {
          ...
          Container(
            ...
            child: TextFormField(
              onSaved: (v) {
                _prescription.notes = v;
              },
              validator: (v) {
                if (v.isEmpty) return "Prescription Details Can't be empty";
                if (v.length < 150) {
          ...
          BlocConsumer<AddPrescriptionBloc, PrescriptionState>(
              ...
              builder: (context, state) {
                    ...
                    onPressed: () {
                      if (_key.currentState.validate()) {
                        ...
                        BlocProvider.of<AppBloc>(context)
                            .prescriptionBloc
                            .add(AddPrescriptionEvent(_prescription));
                      }
                    },
                ...
                if (state is AddPrescriptionsErrorState) {
                  Fluttertoast.showToast(
                    msg: "Error adding prescription: ${state.error}",
                    toastLength: Toast.LENGTH_SHORT,
                    timeInSecForIosWeb: 1,
                  );
                }
